/*! \file panel_test_challenger3.c \brief  Panel test menu definition.*/
// ****************************************************************************
//
//                      MSI ScaleCore
//
...
BYTE	panel_test_menu_battery_reading_mapper( BYTE actionMode, PANEL_SETUP_SUB_MENU_CLASS *pSetupObj, void *pV )
{
	...
	led_display_format_high_resolution_float_string( gaLSensorDescriptor[7].value, &countby, FALSE, bStrBuf );
