/*! \file led_display_hw3460.h \brief High Level LED display related functions.*/
// ****************************************************************************
//
//                      MSI ScaleCore
//
...
/// \code #include "led_display_hw3460.h" \endcode
/// \par Overview
...
#ifndef MSI_LED_DISPLAY_HW3460_H
#define MSI_LED_DISPLAY_HW3460_H

#include  "hw3460_led.h"

void	led_display_set_all_annunciators_state( BYTE state );	// 2012-10-01 -WFC-

// intensity value range from 0 to 15
#define LED_HW_INTENSITY_CMD    LED_MAX7221_INTENSITY_CMD
#define LED_HW_SHUTDOWN_CMD     LED_MAX7221_SHUTDOWN_CMD
#define LED_HW_SHUTDOWN_YES     LED_MAX7221_SHUTDOWN_YES
#define LED_HW_SHUTDOWN_NO      LED_MAX7221_SHUTDOWN_NO
 ...
 */
#define led_display_start_hw_display_test()		hw3460_led_send_cmd( LED_MAX7221_TEST_CMD, LED_MAX7221_TEST_YES); // set the LED driver chip in self test mode.
 ...
 * History:  Created on 2009/08/13 by Wai Fai Chin
 */
#define led_display_stop_hw_display_test()		hw3460_led_send_cmd( LED_MAX7221_TEST_CMD, LED_MAX7221_TEST_NO);
 ...
 */
#define led_display_string( pbStr )		hw3460_led_display_string( (BYTE *)(pbStr))	
 ...
 * History:  Created on 2009/05/28 by Wai Fai Chin
 */
#define led_display_a_digit( loc, ch, isDecPt )		hw3460_led_display_a_digit( (BYTE) (loc), (const BYTE) (ch), (const BYTE) (isDecPt) )
 ...
 */
#define led_display_send_hw_cmd( cmd, value )		hw3460_led_send_cmd( (const BYTE) (cmd), (const BYTE) (value) )
 ...
 */
#define led_display_power_off()		hw3460_led_send_cmd( LED_MAX7221_SHUTDOWN_CMD, LED_MAX7221_SHUTDOWN_YES )
 ...
 * History:  Created on 2009/08/12 by Wai Fai Chin
 */
#define led_display_power_on()		hw3460_led_send_cmd( LED_MAX7221_SHUTDOWN_CMD, LED_MAX7221_SHUTDOWN_NO )
 ...
 * History:  Created on 2009/08/12 by Wai Fai Chin
 */
#define led_display_hardware_init()		hw3460_led_init()
...
*/
#define  led_display_get_format_ctrl( pbStr, pbStrLen )		hw3460_led_get_format_ctrl( (BYTE *) (pbStr), (BYTE *)( pbStrLen))


#define	LED_DISPLAY_MAX_DIGIT_LENGTH		HW3460_LED_MAX_DIGIT_LENGTH
...
#define	LED_DISPLAY_ANC_MINUS	0
#define	LED_DISPLAY_ANC_BAT		1
#define	LED_DISPLAY_ANC_PEAK	2
#define	LED_DISPLAY_ANC_NET		3
#define	LED_DISPLAY_ANC_GROSS	4
#define	LED_DISPLAY_ANC_X1000	5
#define	LED_DISPLAY_ANC_TOTAL	6
#define	LED_DISPLAY_ANC_KG		7

#define	LED_DISPLAY_ANC_MOTION	8
#define	LED_DISPLAY_ANC_SP1		9
#define	LED_DISPLAY_ANC_ACKIN	10
#define	LED_DISPLAY_ANC_ACKOUT	11
#define	LED_DISPLAY_ANC_RF		12
#define	LED_DISPLAY_ANC_COZ		13
#define	LED_DISPLAY_ANC_SP2		14
#define	LED_DISPLAY_ANC_SP3		15

#define	LED_DISPLAY_ANC_LB		16		// Not belong in an image group.
...
#define	LED_DISPLAY_MAX_ANC_INDEX				17
#define	LED_DISPLAY_MAX_DIRECT_UPDATE_ANC_INDEX	16
#define	LED_DISPLAY_FIRST_ANC_NUM				0
#define	LED_DISPLAY_LAST_ANC_NUM				LED_DISPLAY_ANC_LB
 ...
 */
#define led_display_maps_annunciators( pLedM, pAncStateBuf )		hw3460_led_maps_annunciators((pLedM), (pAncStateBuf))
 ...
 * History:  Created on 2011-03-10 by Wai Fai Chin
 */
#define led_display_set_intensity( level )		hw3460_led_send_cmd( LED_HW_INTENSITY_CMD, (const BYTE) (level) )
...
#endif  // MSI_LED_DISPLAY_HW3460_H
